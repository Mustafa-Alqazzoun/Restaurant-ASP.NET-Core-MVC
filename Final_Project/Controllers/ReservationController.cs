...
//        {
//            System.Diagnostics.Debug.WriteLine($"Input: CustomerID={model.CustomerID}, ReservationTime={model.ReservationTime}, NumberOfGuests={model.NumberOfGuests}, IsIndoor={model.IsIndoor}, BranchID={model.BranchID}");
...
//            return coord1.GetDistanceTo(coord2) / 1000; // Convert meters to kilometers
//        }
//    }
